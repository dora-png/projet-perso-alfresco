...
:build_share
    ...
    docker-compose -f "%COMPOSE_FILE_PATH%" rm -f demo-projet-share
	call %MVN_EXEC% clean package -pl demo-projet-share,demo-projet-share-docker
EXIT /B 0
:build_acs
    docker-compose -f "%COMPOSE_FILE_PATH%" kill demo-projet-acs
    docker-compose -f "%COMPOSE_FILE_PATH%" rm -f demo-projet-acs
	call %MVN_EXEC% clean package -pl demo-projet-integration-tests,demo-projet-platform,demo-projet-platform-docker
EXIT /B 0
:tail
...
EXIT /B 0
:prepare-test
    call %MVN_EXEC% verify -DskipTests=true -pl demo-projet-platform,demo-projet-integration-tests,demo-projet-platform-docker
EXIT /B 0
:test
    call %MVN_EXEC% verify -pl demo-projet-platform,demo-projet-integration-tests
EXIT /B 0
:purge
